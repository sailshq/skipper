...
module.exports = function toParseMultipartHTTPRequest (options) {
	return function _parseMultipartHTTPRequest (req, res, next) {
		...
		// by your app.  If `req._sails` exists, this will attempt to log a message
		// to the console using your configured logger.  If this doesn't work, it
		// fails silently.
		parser.on('warning', function (msg) {
			...
			// TODO: remove this log before publishing
